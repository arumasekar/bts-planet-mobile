...
import 'package:bts_planet_mobile/model/item_produk.dart'; // Pastikan import model item
...
import 'package:bts_planet_mobile/screens/satuItem.dart';
...
class _ItemPageState extends State<ItemPage> {
  Future<List<Item>> fetchItem() async {
    ...
    var url = Uri.parse(
        'https://wahyu-aji21-tugas.pbp.cs.ui.ac.id/json-item/$uname/');
